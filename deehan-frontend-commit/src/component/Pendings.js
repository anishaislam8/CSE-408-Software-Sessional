    ...
    render() {
        return(
            <div className="container">
                ...
                <div className="col">
                <Button variant="warning" onClick={this.showSortDiv} style={{"marginBottom":20, "marginRight":10, "width" : 200}} ><FaIcons.FaArrowsAltV size={30}/>{this.state.showSortRatingOrder ? "  Hide Sorting" : "  Sort Pendings"}</Button>
                </div>
                <div className="col">
                ...
                <div className="col">
                <Button variant="success" onClick={this.showAllData} style={{"marginBottom":20, "marginRight":10, "width" : 200}} ><BsIcons.BsCardChecklist size={30}/> Show All Pending</Button>       
                </div>
                <div className="col">
