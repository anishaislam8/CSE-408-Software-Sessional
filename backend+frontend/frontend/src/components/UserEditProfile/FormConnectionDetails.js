          ...
          <div className="row">
            <div className="col">
              <img
                src={logo}
                alt="loading..."
                style={{ height: 500, marginLeft: 120, marginTop: 150 }}
              />
            </div>

            <div className="col">
              <form
                className="registration2inner"
                style={{ marginTop: 240, marginLeft: 100 }}
                  ...
                  <div className="col">
                    <div className="form-group">
                      ...
                      >
                        ...
                        {values.searchdistricts.map((district) => (
                          <option
                  ...
                  <div className="col">
                    <div className="form-group">
                      ...
                      >
                        ...
                        {values.searchupazillas.map((upazilla) => (
                          <option
                ...
                <div className="row">
                  <div className="col">
                    <div className="form-group">
                      ...
                      <select
                        className="form-control"
                        value={values.wire_type}
                        onChange={handleChange("wire_type")}
                        style={{ width: 120 }}
                        required
                      >
                        <option value={""} disabled hidden>
                  ...
                  <div className="col">
                    <div className="form-group">
                      ...
                      >
                        ...
                        {values.searchIsps.map((isp) => (
                          <option key={isp._id} value={isp._id}>
                            {isp.name}, Rating : {isp.average_rating}{" "}
                          </option>
                        ))}
                      </select>
                    </div>
                  ...
                  <div className="col">
                    <div className="form-group">
                      ...
                      <button
                        disabled={values.selectedIsp ? false : true}
                ...
                <div className="row">
                  ...
                  <div className="col">
                    <button
                      ...
                      style={{ marginTop: 20, width: 170 }}
                    >
                      <FaIcons.FaStepBackward size={20} /> Previous
                    </button>
                  </div>
                  <div className="col">
                    <button
