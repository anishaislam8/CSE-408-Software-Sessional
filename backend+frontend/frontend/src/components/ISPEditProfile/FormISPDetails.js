        ...
        return (
           <div>
                ...
                <nav className="navbar fixed-top">
                    <span className="ms-auto"><h3 className="display-5" style={{"marginTop" : 20}}>Edit Basic Information</h3></span>
                </nav>
                    ...
                    <div className="col">
                        <form className="registration1inner" style={{"marginTop":100, "marginLeft":200}} onSubmit={this.continue}>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" disabled value={values.isp_name} onChange={handleChange('isp_name')} className="form-control" placeholder="Enter ISP Name" required minLength="1" maxLength="100"/>
                            </div>

                            <div className="form-group">
                                <label>License Number</label>
                                <input type="text" disabled value={values.license_number} onChange={handleChange('license_number')} className="form-control" placeholder="Enter License Number" minLength="6"  required/>
                            </div>
                            ...
                            <div className="row">
                                <div className="col">
                                    <Link type="button" className="btn btn-dark btn-lg" style={{"marginTop" : 20, "width":150}} to={{
