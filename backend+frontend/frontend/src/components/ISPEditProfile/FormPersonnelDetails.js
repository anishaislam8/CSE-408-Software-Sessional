        ...
        return (
           <div>
                ...
                <nav className="navbar fixed-top">
                    <span className="ms-auto"><h3 className="display-5" style={{"marginTop" : 20}}>Edit Contact Person Details</h3></span>
                </nav>
                ...
                <div className="row">
                    ...
                    <div className="col">
                        <form className="registration3inner" style={{"marginTop":120, "marginLeft":200}} onSubmit={this.continue}>
                            ...
                            <div className="row">
                                <div className="col">
                                    <Link type="button" className="btn btn-danger btn-lg" style={{"marginTop" : 20, "width":150}} to={{
                                ...
                                <div className="col">
                                    <button type="submit"  className="btn btn-info btn-lg" style={{"marginTop" : 20, "width":150}}>Continue <ImIcons.ImNext2 size={30} /></button>
                                </div>
                            </div>
